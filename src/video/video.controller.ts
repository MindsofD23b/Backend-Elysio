...
export class VideoController {
    ...
    async connectTransport(
        ...
        await this.mediaService.connectTransport(roomId, peerId, transportId, dtlsParameters)
    ...
    async produce(
        ...
        return this.mediaService.createProducer(roomId, peerId, transportId, kind, rtpParameters)
    }
